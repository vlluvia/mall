...
public interface GoodsDao extends BaseMapper<Goods> {
    ...
    @Delete("delete from goods_detail where goods_id = #{id}")
    void deleteGoodsDetailByGoodsId(int id);

    @Update("update goods set goods_type_id=#{goodsTypeId},goods_name=#{goodsName},goods_src=#{goodsSrc},goods_desc=#{goodsDesc},goods_price=#{price} where id=#{id}")
